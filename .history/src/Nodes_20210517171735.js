...
class Nodes extends Component{
    ...
    render(){
        const nodeClass = this.props.start ? 'Node node-start' :  this.props.end ? 'Node node-end' : this.props.wall ? 'Node node-wall' : this.props.visited ? 'Node node-visited' : 'Node'
        return(
