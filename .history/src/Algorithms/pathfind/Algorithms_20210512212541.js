            ...
            if (current.end) {
                ...
                if (!current.wall) {
                    ...
                    if(current.start){
                        console.log(speed)
                        console.log(current)
                        console.log(cacheNeighbours)
                        console.log('flag')
                    }
                    if (current.top != null && !grid[current.top][current.col].wall && !visited.has(grid[current.top][current.col]) && cacheNeighbours.has(grid[current.top][current.col]) === false) {
                    ...
                    if (current.bottom != null && !grid[current.bottom][current.row].wall && !visited.has(grid[current.bottom][current.col]) && !cacheNeighbours.has(grid[current.bottom][current.col])) {
                    ...
                    if (current.left != null && !grid[current.row][current.col].wall && !visited.has(grid[current.row][current.left] && !cacheNeighbours.has(grid[current.row][current.left]))) {
                    ...
                    if (current.right != null && !grid[current.row][current.right].wall &&  !visited.has(grid[current.row][current.right]) && !cacheNeighbours.has(grid[current.row][current.right])) {
