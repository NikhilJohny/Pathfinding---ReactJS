...
export default class Algorithms extends Component {
    ...
    recursiveDivisionMaze(grid, startNode, finishNode) {
      ...
      //dir === 1 => Vertical
       ...
       async getRecursiveWalls(vertical, horizontal, grid, startNode, finishNode) {
      ...
      //dir === 1 => Vertical
       ...
       async addWall(grid,dir, num, vertical, horizontal, startNode, finishNode) {
        ...
        for (let wall of tempWalls) {
            await delay(100)
            grid[wall[0]][wall[1]].wall = true
            this.props.change(grid[wall[0]][wall[1]],'Node node-wall')
          }
      }
    ...
    render() {
        if (this.props.paused) {
            ...
            let success = this.recursiveDivisionMaze(clone, clone[0][0],clone[19][59])
            if(!success) this.bfs(clone,this.props.start)
        }
        return ( 
            <div>hi</div>
        )
