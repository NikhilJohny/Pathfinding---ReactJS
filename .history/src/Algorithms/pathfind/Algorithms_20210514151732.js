    ...
    async dfs(grid, current) {
        if(current.end){
            ...
            if(!current.wall){
                ...
                if (current.top != null && !grid[current.top][current.col].visited) {
                    grid[current.top][current.col].previous = current
                    this.dfs(grid,grid[current.top][current.col])
                }
                if (current.bottom != null && !grid[current.bottom][current.col].visited) {
                    grid[current.bottom][current.col].previous = current
                    this.dfs(grid,grid[current.bottom][current.col])
                }
                if (current.left != null && !grid[current.row][current.left].visited) {
                    grid[current.row][current.left].previous = current
                    this.dfs(grid,grid[current.row][current.left])
                }
                if (current.right != null && !grid[current.row][current.right].visited) {
                    grid[current.row][current.right].previous = current
                    this.dfs(grid,grid[current.row][current.right])
                }
            }
        }
        // let neighbors = [start]
