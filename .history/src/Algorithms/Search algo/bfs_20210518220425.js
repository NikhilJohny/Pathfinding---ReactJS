    ...
    while (neighbors.length) {
        ...
        if (current.end) {
            ...
            if (!current.wall || (current.start && current.wall)) {
                ...
                cacheNeighbors.add(current.no)
                visitedPath.push([current.row, current.col])

                if (current.top != null && !visited.has(grid[current.top][current.col].no) && !cacheNeighbors.has(grid[current.top][current.col].no)) {
                    grid[current.top][current.col].previous = current
                    cacheNeighbors.add(grid[current.top][current.col].no)
                    neighbors.push(grid[current.top][current.col])
                }
                if (current.bottom != null && !visited.has(grid[current.bottom][current.col].no) && !cacheNeighbors.has(grid[current.bottom][current.col].no)) {
                    cacheNeighbors.add(grid[current.bottom][current.col].no)
                    grid[current.bottom][current.col].previous = current
                    neighbors.push(grid[current.bottom][current.col])
                }
                if (current.left != null && !visited.has(grid[current.row][current.left].no) && !cacheNeighbors.has(grid[current.row][current.left].no)) {
                    cacheNeighbors.add(grid[current.row][current.left].no)
                    grid[current.row][current.left].previous = current
                    neighbors.push(grid[current.row][current.left])
                }
                if (current.right != null && !visited.has(grid[current.row][current.right].no) && !cacheNeighbors.has(grid[current.row][current.right].no)) {
                    cacheNeighbors.add(grid[current.row][current.right].no)
